...
top_k·top_p 는 반복·붕괴에 거의 영향이 없는 **후순위 파라미터** 이다. 오히려 후보를 좁힐수록 greedy 처럼 동작해 완주율만 떨어지고, 페널티와 달리 커버리지(ocr/actions/sounds)는 깎지 않는다. **결론은 기본값** `top_p 1.0 · top_k -1` **유지** 
...
- **완주율 하락**
  - top_k 1·top_p 0.5 처럼 후보를 좁히면 finish_len 18\~22%·완주 78\~82%로 악화됨

- **안전 구간**
  - 느슨한 쪽(k≥10·p≥0.95)이 안전하며, 그 안에서는 설정 간 유의미한 차이가 없음.

#### 2. 반복 제어 수단이 아님

- **repeat 평탄·무추세**
  - 전 구간 13\~24%로 평탄해(4회 모두 추세 없음) top_k·top_p 로는 반복을 제어할 수 없습니다.

:::note
💡 **top_p 1.0 · top_k -1 (기본값 유지)**

temp 0.7 anchor 에서 후보를 조이면 완주율만 잃고 얻는 것이 없음. full sampling 기본 값을 유지하고, 다양성 제어는 temperature 하나로 일원화한다.
...
| 1 | rep 1.05 | 94.29% | 2534.6 | 24.30% | 4.30% | 5.70% | 0.00% | 8.57% | 100.00% | 87.90% | 100.00% | 92.40% |
| 2 | rep 1.05 | 87.14% | 2718.6 | 20.00% | 0.00% | 12.90% | 0.00% | 8.23% | 100.00% | 86.90% | 100.00% | 95.10% |
| 3 | rep 1.05 | 91.43% | 2557.9 | 17.10% | 1.40% | 8.60% | 0.00% | 6.78% | 100.00% | 87.50% | 100.00% | 90.60% |
| 4 | rep 1.05 | 87.14% | 2771.5 | 22.90% | 1.40% | 12.90% | 0.00% | 9.30% | 100.00% | 85.20% | 100.00% | 88.50% |
| 1 | rep 1.1 | 94.29% | 2251.1 | 7.10% | 0.00% | 5.70% | 0.00% | 3.20% | 100.00% | 83.30% | 100.00% | 84.80% |
| 2 | rep 1.1 | 95.71% | 2243.5 | 8.60% | 0.00% | 4.30% | 0.00% | 3.23% | 100.00% | 89.60% | 100.00% | 88.10% |
| 3 | rep 1.1 | 98.57% | 2087.9 | 11.40% | 1.40% | 1.40% | 0.00% | 3.55% | 100.00% | 85.50% | 100.00% | 92.80% |
| 4 | rep 1.1 | 95.71% | 2285.4 | 17.10% | 2.90% | 4.30% | 0.00% | 6.08% | 100.00% | 89.60% | 100.00% | 88.10% |
| 1 | rep 1.3 | 100.00% | 2035.8 | 14.30% | 4.30% | 0.00% | 0.00% | 4.65% | 100.00% | 91.40% | 98.60% | 85.70% |
| 2 | rep 1.3 | 100.00% | 1949 | 15.70% | 0.00% | 0.00% | 0.00% | 3.93% | 100.00% | 85.70% | 100.00% | 82.90% |
| 3 | rep 1.3 | 100.00% | 1827.6 | 12.90% | 2.90% | 0.00% | 0.00% | 3.95% | 100.00% | 91.40% | 100.00% | 78.60% |
| 4 | rep 1.3 | 98.57% | 1988.5 | 7.10% | 0.00% | 1.40% | 0.00% | 2.12% | 100.00% | 87.00% | 100.00% | 81.20% |
|  |  | 100.00% | 1641.3 | 1.40% | 8.60% | 0.00% | 0.00% | 2.50% | 100.00% | 87.10% | 80.00% | 68.60% |
|  |  | 98.57% | 1711.9 | 0.00% | 8.60% | 1.40% | 0.00% | 2.50% | 100.00% | 91.30% | 75.40% | 59.40% |
|  |  | 100.00% | 1654.8 | 0.00% | 5.70% | 0.00% | 1.40% | 1.78% | 100.00% | 88.60% | 77.10% | 61.40% |
|  |  | 100.00% | 1509.3 | 0.00% | 5.70% | 0.00% | 0.00% | 1.43% | 100.00% | 90.00% | 78.60% | 61.40% |


</details>

페널티는 temperature 0.7 에서 완주를 확실히 끌어올리는 레버로 확인됐다. freq 0.0→0.5 만으로 완주율이 90%→99.6%, penalty 가 7.0%→2.0%로 떨어짐. 다만 강도에 비례해 sounds 커버리지가 함께 줄어들며(88%→79%→65%→43%), 이 감소가 잉여 제거인지 정보 삭제인지는 정답지 없이 판정할 수 없음.
