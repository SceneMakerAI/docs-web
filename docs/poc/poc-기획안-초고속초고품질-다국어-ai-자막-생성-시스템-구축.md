...
- **핵심 목표:** 
  ...
  - 2. 문장별/구간별 실시간 다국어 교차 인식(Code-switching) 및 공백 처리 구현
...
| **1시간 오디오 처리 시간**
*(RTX 4090 / WhisperX 배치 기준)* | 약 45초 \~ 1분 내외 | **약 15초 \~ 20초 내외** | **Turbo가 약 3배 이상 빠름** (I/O 속도 제외 순수 연산) |
...
| RTX 4090 기준
1시간 처리 시간 | **🚀 약 10초 \~ 15초** | 약 1분 30초 \~ 2분 | 약 45초 \~ 1분 | 약 1분 \~ 1분 30초 |
